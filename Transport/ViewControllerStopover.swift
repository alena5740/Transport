...
final class StopoverViewController: UIViewController {
    ...
    var presenter: PresenterStopoverProtocol?
...
extension StopoverViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let mapViewController = assembly?.pushToViewControllerMap(modelStopover: model) {
...
extension StopoverViewController: ViewOutputProtocol {
    func updateView() {
